      ...
      <div className="container">
        ...
        <div className="legal-content">
          ...
          <section>
            <h2>Introduction</h2>
            <p>
              When you use cutcab, you place your trust in us with your personal data, and we take this trust seriously. 
          ...
          <section>
            ...
            <h3>Scope</h3>
            <p>
              This notice is intended for users of cutcab in the United Kingdom who utilise the mobile application and 
          ...
          <section>
            ...
            <p>
              SHARX LTD is the designated data controller responsible for data collected from cutcab's services in the 
              United Kingdom. cutcab only shares personal data with law enforcement agencies in compliance with the 
              regulatory requirements of applicable laws, such as the GDPR.
            </p>
            <p>To ensure data protection when you use our services, cutcab has implemented the following safeguards:</p>
            <ul>
              <li>
                Data is safeguarded during transmission between the cutcab app and our servers, as well as during 
          ...
          <section>
            ...
            <p>CutCab collects data in two main ways:</p>
            
            <h3>Data Provided by Users to cutcab</h3>
            <p>
            ...
            <ul>
              ...
              <li><strong>Travel Information:</strong> Details about upcoming trips, including dates and times, which users manually input into the cutcab app.</li>
          ...
          <section>
            ...
            <p>CutCab employs personal data to facilitate a dependable and convenient taxi-sharing service. We use data for:</p>
            <ul>
          ...
          <section>
            ...
            <p>CutCab may share data as follows:</p>
            <ul>
          ...
          <section>
            ...
            <p>
              CutCab retains user data for the duration necessary for the purposes outlined above. Users can request 
              the deletion of their accounts at any time. Following a deletion request, cutcab retains user data for 30 
            ...
            <p>
              ...
              account</strong> in the cutcab app.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              CutCab app uses google services (The Google Maps API(s)) which means that is bind to the related Google 
          ...
          <section>
            ...
            <ul>
              <li><strong>Accessing Data:</strong> Users can access their data via the cutcab app.</li>
              <li><strong>Data Portability:</strong> Users can request a copy of their data by contacting CutCab via email.</li>
          ...
          <section>
            ...
            <p>
              ...
              advance via the cutcab app or through email. Use of our services following an update constitutes consent 
